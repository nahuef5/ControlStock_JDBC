...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarCamposDelFormulario(Container container) {
        ...
        labelCategoria = new JLabel("Categori­a del Producto");
    ...
    private void configurarAccionesDelFormulario() {
        ...
        botonReporte.addActionListener((ActionEvent e) -> {
            abrirReporte();
        });
    }
    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filasModificadas = this.productoController.modificarProducto(nombre, descripcion, cantidad, id);
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filasModificadas = this.productoController.eliminarProducto(id);
    ...
    private void cargarTabla() {  
        var productos = this.productoController.listarProducto();
    ...
    private void guardar() {
        ...
        this.productoController.guardarProducto(producto, categoria.getCategoriaId());
